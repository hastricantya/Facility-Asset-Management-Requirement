          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="md:col-span-2">
              ...
              <div className="relative">
                ...
                <input 
                  type="text" 
                  disabled={isView}
                  className="w-full bg-white border border-gray-200 rounded-xl pl-12 pr-4 py-3.5 text-sm font-bold text-black focus:border-black focus:ring-2 focus:ring-gray-100 outline-none transition-all placeholder:text-gray-300 disabled:bg-gray-50"
            ...
            <div>
              ...
              <div className="flex gap-3">
                <button 
                  ...
                  className={`flex-1 py-3 text-[11px] font-black rounded-xl border transition-all ${form.aktif ? 'bg-black text-white border-black shadow-lg shadow-black/10' : 'bg-white text-gray-400 border-gray-200'}`}
                >
                  AKTIF
                </button>
                <button 
                  ...
                  className={`flex-1 py-3 text-[11px] font-black rounded-xl border transition-all ${!form.aktif ? 'bg-red-600 text-white border-red-600 shadow-lg shadow-red-100' : 'bg-white text-gray-400 border-gray-200'}`}
                >
                  TIDAK AKTIF
                </button>
              </div>
            ...
            <div className="md:col-span-2">
              ...
              <div className="relative">
                ...
                <textarea 
                  disabled={isView}
                  className="w-full bg-white border border-gray-200 rounded-xl pl-12 pr-4 py-3.5 text-sm font-bold text-black focus:border-black focus:ring-2 focus:ring-gray-100 outline-none transition-all placeholder:text-gray-300 disabled:bg-gray-50 min-h-[100px]"
        ...
        <div className="px-8 py-5 bg-gray-50 border-t border-gray-100 flex gap-4">
          ...
          {!isView && (
            <button 
              onClick={handleSave}
              disabled={!form.nama}
              className="flex-[2] py-3.5 text-[11px] font-black text-white bg-black rounded-xl shadow-xl shadow-black/20 hover:bg-gray-900 transition-all flex items-center justify-center gap-2 uppercase tracking-widest active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
            >
